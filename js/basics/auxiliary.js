/**
 * Contains basic functions used to handle data matrix, similarity matrix, validation and ect.
 */
...
function showSim() {
    ...
    switch (selectedMethod) {
        ...
        case "8":
            ...
            document.getElementById("basicInfo2").innerHTML = "*This methods arranges the dimensions so that neighboring sequence has the overall highest similarity <br> *Reference: <a class='links' href='https://ieeexplore.ieee.org/abstract/document/729559'>Similarity Clustering of Dimensions for\n" +
                "an Enhanced Visualization of Multidimensional Data</a> ";
            break;
        case "9":
            document.getElementById("choose").innerHTML = "Please choose a similarity measure:";
            document.getElementById("similarity").className = "show";
            document.getElementById("basicInfo2").innerHTML = "*This methods arranges the dimensions so that neighboring sequence has the overall lowest similarity <br> *Reference: <a class='links' href='https://ieeexplore.ieee.org/abstract/document/729559'>Similarity Clustering of Dimensions for\n" +
                "an Enhanced Visualization of Multidimensional Data</a> ";
            break;
        default:
